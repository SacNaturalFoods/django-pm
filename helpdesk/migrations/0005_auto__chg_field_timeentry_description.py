...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeEntry.description'
        db.alter_column('helpdesk_timeentry', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'TimeEntry.description'
        db.alter_column('helpdesk_timeentry', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
