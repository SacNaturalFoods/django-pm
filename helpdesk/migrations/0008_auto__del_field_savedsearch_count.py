...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SavedSearch.count'
        db.delete_column('helpdesk_savedsearch', 'count')


    def backwards(self, orm):
        
        # Adding field 'SavedSearch.count'
        db.add_column('helpdesk_savedsearch', 'count', self.gf('django.db.models.fields.IntegerField')(default=None), keep_default=False)
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 16, 17, 3, 24, 666466)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
