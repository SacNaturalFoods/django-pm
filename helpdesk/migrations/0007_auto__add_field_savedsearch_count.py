...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('helpdesk_savedsearch', 'count', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 16, 17, 0, 2, 967410)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
