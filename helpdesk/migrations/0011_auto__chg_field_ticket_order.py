...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.order'
        db.alter_column('helpdesk_ticket', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Ticket.order'
        db.alter_column('helpdesk_ticket', 'order', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 35, 41, 998488)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 35, 41, 998376)'}),
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 35, 13, 373642)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
