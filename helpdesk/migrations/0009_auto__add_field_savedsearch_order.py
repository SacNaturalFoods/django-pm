...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.order'
        db.add_column('helpdesk_savedsearch', 'order', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SavedSearch.order'
        db.delete_column('helpdesk_savedsearch', 'order')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 10, 27, 41, 132822)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
