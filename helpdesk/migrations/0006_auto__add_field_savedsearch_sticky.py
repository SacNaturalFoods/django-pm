...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.sticky'
        db.add_column('helpdesk_savedsearch', 'sticky', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SavedSearch.sticky'
        db.delete_column('helpdesk_savedsearch', 'sticky')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 6, 14, 8, 27, 787561)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
