...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.milestone'
        db.alter_column('helpdesk_ticket', 'milestone_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['helpdesk.Milestone'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Ticket.milestone'
        db.alter_column('helpdesk_ticket', 'milestone_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['helpdesk.Milestone'], null=True))
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'helpdesk.ticket': {
            ...
            'milestone': ('smart_selects.db_fields.ChainedForeignKey', [], {'to': "orm['helpdesk.Milestone']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
