...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedSearch.per_page'
        db.add_column('helpdesk_savedsearch', 'per_page',
                      self.gf('django.db.models.fields.IntegerField')(default=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedSearch.per_page'
        db.delete_column('helpdesk_savedsearch', 'per_page')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'helpdesk.savedsearch': {
            ...
            'per_page': ('django.db.models.fields.IntegerField', [], {'default': '10', 'null': 'True', 'blank': 'True'}),
