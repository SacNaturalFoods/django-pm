...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('helpdesk_milestone', (
        ...
        db.send_create_signal('helpdesk', ['Milestone'])

        # Adding field 'Ticket.milestone'
        db.add_column('helpdesk_ticket', 'milestone',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helpdesk.Milestone'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ticket.tags'
        from helpdesk.models import Ticket
        if not 'tags' in [f.attname for f in Ticket._meta.fields]:
            db.add_column('helpdesk_ticket', 'tags',
                          self.gf('tagging_autocomplete_tagit.models.TagAutocompleteTagItField')(default=''),
                          keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Milestone'
        db.delete_table('helpdesk_milestone')

        # Deleting field 'Ticket.milestone'
        db.delete_column('helpdesk_ticket', 'milestone_id')
    ...
    models = {
        ...
        'helpdesk.followup': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'helpdesk.ticket': {
            ...
            'milestone': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['helpdesk.Milestone']", 'null': 'True', 'blank': 'True'}),
